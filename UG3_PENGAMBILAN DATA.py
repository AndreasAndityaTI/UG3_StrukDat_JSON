...
for data in json_data[0:limit]:
    kasus_data.append(data['jumlah_kasus'])
    sembuh_data.append(data['jumlah_sembuh'])
    meninggal_data.append(data['jumlah_meninggal'])
    dirawat_data.append(data['jumlah_dirawat'])
